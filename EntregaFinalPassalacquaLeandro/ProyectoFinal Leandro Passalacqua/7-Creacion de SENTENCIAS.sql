...
-- 1  EJECUTAR LINEAS INDIVIDUALMENTE
...
DROP USER 'LEADIRECTOR'@'localhost';
...
GRANT SELECT, INSERT,UPDATE ON proyectofinalleandropassalacqua.pedidos TO 'AFRICANUS'@'localhost';
